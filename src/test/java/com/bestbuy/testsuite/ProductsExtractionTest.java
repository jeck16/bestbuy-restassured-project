...
public class ProductsExtractionTest {
    ...
    @Test
    public void ZipOfRosevilleStore() {
    ...
    @Test
    public void AllDescriptionOfProducts() {
    ...
    @Test
    public void AllProductOfTypeHarGood() {
